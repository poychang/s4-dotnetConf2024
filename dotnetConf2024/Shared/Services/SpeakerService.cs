        ...
        public IEnumerable<SpeakerModel> GetSpeakers()
        {
            var speakers = new List<SpeakerModel> {
                ...
                new SpeakerModel {
                    ...
                    TwitterUrl = "",
                    LinkedinUrl = "",
                    Introduction = "連續十二年成功獲選 Microsoft MVP 和 VMware vExpert 技術專家，並長期擔任網管人雜誌技術專欄作家，曾任 Modern Web Conference 2024、Kubernetes Summit 2024、COSCUP 2024、Cloud Summit Taiwan 2024、Kubernetes Summit 2022、DevOpsDays Taipei 2022、Cloud Edge Summit Taiwan 2022、SRE Conference 2022……等研討會講師，專長為打造 SDDC 軟體定義資料中心、HCI 超融合解決方案、IaC 基礎架構即程式碼環境……等，著有微軟 S2D 軟體定義儲存技術實戰……等共 19 本著作。",
